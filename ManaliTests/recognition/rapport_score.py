...
class RapportScore:
    def __init__(self, min_words=None, overlap=None):
        ...
        model_dict = joblib.load('D:\\HCI_Research\\ManaliTests\\recognition\\rapport_classifier.joblib')
    ...
    def load_saved_parameters(self):
        if os.path.isfile('D:\\HCI_Research\\ManaliTests\\recognition\\rapport_classifier.joblib'):
            model_dict = joblib.load('D:\\HCI_Research\\ManaliTests\\recognition\\rapport_classifier.joblib')
    ...
    def tune_parameters(self):
        ...
        self.rapport_data = load_and_convert_to_utterances('D:\\HCI_Research\\ManaliTests\\recognition\\rapport_examples.txt')
        self.non_rapport_data = load_and_convert_to_utterances('D:\\HCI_Research\\ManaliTests\\recognition\\generated_examples.txt')
